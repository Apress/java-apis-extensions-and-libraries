...
public class CallableStatementTest {
    ...
    public static void giveRaise(Connection conn, int personId, double raise) throws SQLException {
        ...
        try {
            ...
            System.out.println("Old Income: " + oldIncome + ", New Income: " + newIncome);
