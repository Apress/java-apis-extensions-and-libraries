...
public class URLConnectionReaderWriter {
    public static String getURLContent(String urlStr, String input) {
        ...
        try {
            ...
            // Must call setDoOutput(true) to indicate that you will write to the 
            // connection. By default, it is false. 
            ...
            // Must be placed after writing the data. Otherwise, it will result in error, 
            // because if write is performed,read must be performed after the write.
