...
public class NonBlockingEchoServer {
    ...
    public static void processAccept(SelectionKey key) throws IOException {
        // This method call indicates that we got a new connection request. Accept 
        // the connection request and register the new socket channel with the selector, 
        // so that client can communicate on a new channel 
