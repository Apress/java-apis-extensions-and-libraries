...
/**
 * An instance of this class is used as a job that sleeps at a regular interval up to a
 * maximum duration. The sleep interval in seconds can be specified as the first argument
 * and the sleep duration as the second argument while running. this class. The default
 * sleep interval and sleep duration are 5 seconds and 60 seconds, respectively. If these
 * values are less than zero, zero is used instead.
 */
public class Job {
     ...
     *
     * @param sleepInterval The sleep interval when the Job class is run. It is passed to
     * the JVM as the first argument.
     * @param sleepDuration The sleep duration for the Job class. It is passed to the JVM
     * as the second argument.
     * @return The new process reference of the newly launched JVM or null if the JVM
     * cannot be launched.
     */
    ...
    /**
     * Used to parse the arguments passed to the JVM, which in turn is passed to the
     * main() method.
     *
     * @param valueStr The string value of the argument
     * @param defaultValue The default value of the argument if the valueStr is not an
     * integer.
     * @return valueStr as a long or the defaultValue if valueStr is not an integer.
     */
    ...
    /**
     * Adds the JVM path to the command list. It first attempts to use the command
     * attribute of the current process; failing that it relies on the java.home system
     * property.
     *
    ...
    /**
     * Adds a main class to the command list. Adds module/className or just className
     * depending on whether the Job class was loaded in a named module or unnamed module
     *
     * @param cmd The command list
     */
